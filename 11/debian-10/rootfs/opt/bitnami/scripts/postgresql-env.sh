...
export REPMGR_PROMOTE_STANDBY_LOCK_FILE_NAME="$REPMGR_LOCK_DIR/promote_to_primary.lock"
...
export REPMGR_WAIT_PRIMARY_TIME="${REPMGR_WAIT_PRIMARY_TIME:-60}"
export REPMGR_WAIT_PRIMARY_STEP="${REPMGR_WAIT_PRIMARY_STEP:-10}"
